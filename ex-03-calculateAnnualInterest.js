...
console.assert(
  someGuy.calculateAnnualInterest.call({ creditScore: 55 }, 100) === 20
);
console.assert(
  someGuy.calculateAnnualInterest.call({ creditScore: 205 }, 100) === 10
);
console.assert(
  someGuy.calculateAnnualInterest.call({ creditScore: 705 }, 100) === 5
);
